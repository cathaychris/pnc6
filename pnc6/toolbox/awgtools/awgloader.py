...
class AWGLoader:
    ...
    def __init__(self, hashname=True, bulkload=False, fileload=False,
                 dot_awg_path=None, awg_dir=None):
        self._awgs = {}
        self._loaded_wforms = []
    ...
    def load_file(self, seqs, delay_override=120e3):
    ...
    def load(self, seqs, delay_override=120e3):
        '''
