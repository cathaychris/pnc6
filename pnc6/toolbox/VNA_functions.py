    ...
    try:
        ...
        for idx_power, power in enumerate(pows):
            ...
            if save and folder:
                ...
                if fit:
                    from toolbox import resonator_fitting as mag_fit_resonator
...
if __name__ == '__main__':
    ...
    vna = instruments['VNA']
    # vna.set_instrument_state_file('reagorr')
    # vna.load_state()
